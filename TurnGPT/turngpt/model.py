...
def load_transformer(
    pretrained_model_name_or_path="rinna/japanese-gpt2-medium", pretrained=True, **model_kwargs
):
    ...
    print( pretrained_model_name_or_path.lower())
    if not (
...
class TurnGPT(pl.LightningModule, Utils):
    ...
    * call `model.initialize_special_embeddings()` to initialize <ts> = eos_token
    ...
    def init_tokenizer(self):
        ...
        self.tokenizer = SpokenDialogTokenizer(pretrained_model_name_or_path= self.name_or_path, language=self.language)
    ...
    @staticmethod
    def add_model_specific_args(parent_parser, language):
        ...
        if language == "Japanese":
            parser.add_argument("--pretrained_model_name_or_path", type=str, default="rinna/japanese-gpt2-medium")
        elif language == "English":
            parser.add_argument("--pretrained_model_name_or_path", type=str, default="openai-community/gpt2")
